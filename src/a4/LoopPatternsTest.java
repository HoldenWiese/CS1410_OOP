...
class LoopPatternsTest {
	...
	public void findSmallestNumberInTwoArraysTest() {
		...
		assertEquals(-6, LoopPatterns.findSmallestNumberInTwoArrays(input1, input2),
				"findSmallestNumberInTwoArraysTest(" + Arrays.toString(input1) + ", " + Arrays.toString(input2)
						+ ") failed.");
		assertEquals(1, LoopPatterns.findSmallestNumberInTwoArrays(input3, input4), "findSmallestNumberInTwoArraysTest("
				+ Arrays.toString(input3) + ", " + Arrays.toString(input4) + ") failed.");
	}
	...
	public void curveScoresTest() {
		...
		assertArrayEquals("curveScores(" + Arrays.toString(input1) + ") failed.", input1Expected,
				LoopPatterns.curveScores(input1));
		assertArrayEquals("curveScores(" + Arrays.toString(input2) + ") failed.", input2Expected,
				LoopPatterns.curveScores(input2));
		assertArrayEquals("curveScores(" + Arrays.toString(input3) + ") failed.", input3Expected,
				LoopPatterns.curveScores(input3));
	}
}
