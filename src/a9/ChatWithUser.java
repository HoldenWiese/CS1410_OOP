 ...
 */
/**
 * This class is used to demonstrate and use the three different chat bots
 * created.
 * 
 * @author Holden
 *
...
public class ChatWithUser {
	...
	/**
	 * Normalizes an input phrase by making it all lowercase and removing all
	 * punctuation. This makes it easier for a chatbot to understand.
	 * 
	...
	/**
	 * Runs a single chatbot session by creating a Chatter object and then passing
	 * it inputs from the user until the user types "stop".
	 * 
	 * This method also takes care of printing the chatbot responses.
	 */
	public static void main(String[] args) {
		// Load a ChatterBot
		Chatter botLast = new ChatterLastWord("Hi, what would you like to talk about?",
				"It was nice chatting with you!", "src/a9/phrases.txt");
		Chatter botFull = new ChatterFullMatch("Hi, what would you like to talk about?",
				"It was nice chatting with you!", "src/a9/phrases.txt");
		Chatter botCustom = new ChatterCustom("Hi, what would you like to talk about?",
				"It was nice chatting with you!", "src/a9/phrases.txt");
